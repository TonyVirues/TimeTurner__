...
<div class="tt-calendario-wrapper">
  ...
  <!-- Selector de horario -->
  <div class="tt-horario-selector d-flex align-items-center gap-2 px-3 py-2 border-bottom bg-white">
    <label for="horarioSelect" class="mb-0 text-muted" style="font-size: 13px; white-space: nowrap;">Selecciona un horario:</label>
    <select id="horarioSelect" class="form-select form-select-sm" style="max-width: 250px;">
